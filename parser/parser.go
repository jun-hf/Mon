...
// Here is the 2 parsing functions
// the ast.Expression passed in infixParseFn is the left operand
// prefixParseFn is called when we encountered an associated token that that is in prefix position
type (
...
func (p *Parser) peekExpect(typ token.TokenType) bool {
